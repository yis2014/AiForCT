...
def get_gray_feature(c_features):
    ...
    c_features['gray_skew'].append(s.skew())
    c_features['gray_kurt'].append(s.kurt())
...
# 创建一个空的列表
c_features = [[] for _ in range(len(features_list))]
...
def main(pid):
    ...
    # 添加'gray_skew'和'gray_kurt'键到c_features字典
    c_features['gray_skew'] = []
    c_features['gray_kurt'] = []
